...
(function(){
  ...
  uliving:{
    ...
    s3:'A Brazilian PBSA platform earns <b>rent on every let bed</b> over the academic year, mostly <b>direct-let</b> (nomination agreements are still rare in the market). Into structural under-supply, new schemes <b>lease up</b> and rents grow as the asset class matures; that is the upside. But the cash flow is in <b>reais</b>, so the investor question is less the demand than the <b>discount rate</b>: Brazilian rates and the real. The return comes down to occupancy × rent on a building leasing into a deep, unmet need.',
  ...
  china:{
    ...
    try:'<b>Try this:</b> the <b>rent</b> per bed is thin, but push the <b>beds</b> slider and watch the absolute cash flow balloon. The model is scale and high occupancy on mass demand rather than price. Occupancy holds high because the demand pool is deep; the operating leverage still bites if a block under-fills, but at this scale the base is enormous.',
