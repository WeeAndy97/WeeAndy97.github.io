...
(function(){
  ...
  hs2:{
    ...
    s3:'Once running, HS2 earns the way every railway does: a <b>fare</b> on every passenger, weighted up for premium seats, plus station retail. But the revenue is trivial against the capital. Its value is <b>strategic</b>: released paths for commuters and freight on the West Coast corridor, faster city-to-city links, and regional regeneration around the new stations. Demand is real and inelastic on a flagship route, yet no fare can carry a £60bn build, which is exactly why it was paid for by the state rather than a fund.',
    mb:{tag:'Model B · government build',title:'State-funded strategic line',body:'The government funds a nation-building railway whose payoff is <b>network capacity and regional growth</b> rather than fare cash; the commercial return is explicitly negative, and a separate train operator pays access charges to run the trains. <b>This is HS2</b>, built by HS2 Ltd for the Department for Transport, repeatedly rescoped on cost, justified on the paths it frees up elsewhere rather than a hurdle rate.'},
    ...
    finNote:'There is no equity and no commercial repayment plan: HS2 is a <b>public-spending decision</b> rather than a project-financed asset. The "stack" is the taxpayer\'s balance sheet, and the case rests on released network capacity and regional growth: benefits that sit outside any single fare-box P&amp;L.',
