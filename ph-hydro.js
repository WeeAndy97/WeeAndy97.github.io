...
(function(){
  ...
  fengning:{
    ...
    s3:'Fengning earns a <b>regulated</b> per-MW revenue: a two-part tariff of a capacity payment (for being available) plus an energy payment (for arbitrage), set by the regulator, so the revenue is contracted-ish and stable, with little merchant exposure. Applied at colossal scale against a low cost base and a low, state-linked cost of capital, a modest revenue per MW is a vast, stable cash flow. The lever is <b>scale and the regulated tariff</b>, with merchant arbitrage a secondary line as power markets reform.',
