...
(function(){
  ...
  chpe:{
    ...
    wfNote:'Because the revenue is contracted, the EBITDA line is about as predictable as infrastructure gets: the main risk to it is an outage on the link rather than a soft power market.',
  ...
  marinus:{
    ...
    finNote:'The CEFC facility, its <b>largest-ever commitment</b>, and tri-government equity replace the private merchant equity that a pure-arbitrage case could not attract. The trade-off is that the spread risk, and the upside, sit with consumers rather than a sponsor.',
  ...
  gccia:{
    ...
    try:'<b>Try this:</b> the value here is not the energy traded but the blackout that <i>didn\'t</i> happen. Push the gap and reserves rush to the short member; the revenue line barely moves, because members pay for the <b>service and the security</b> rather than the megawatt-hours.',
  ...
  cahora:{
    ...
    wfNote:'Operating cost is the upkeep of an ageing overhead line, its towers and right-of-way, plus the converter valves. The margin is high; the risk is political and counterparty rather than operational.',
