...
(function(){
  ...
  sydney:{
    ...
    lede:'The world\'s most famous steel arch, and a reminder that on a <b>government-owned</b> crossing the toll serves as a public revenue and congestion lever; no private return is involved.',
  ...
  kingfahd:{
    ...
    lede:'A 25&nbsp;km sovereign causeway joining Saudi Arabia to the island of Bahrain, a <b>jointly-owned, toll-funded</b> link whose payoff is measured in bilateral trade and tourism, not in an IRR.',
  ...
  hzmb:{
    ...
    mb:{tag:'Model B · strategic asset',title:'Government-funded megaproject',body:'Three governments fund a nation-building crossing whose payoff is <b>economic integration</b> (the toll cash is incidental); commercial returns are explicitly low, and demand is shaped by cross-border policy and quotas. <b>This is HZMB</b>, funded ~42% by tripartite government contributions and ~58% by bank loans, operated by the HZMB Authority for the Greater Bay Area; no hurdle rate applies.'},
