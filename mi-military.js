...
(function(){
  ...
  china:{
    ...
    s4a:'The partner carries <b>facilities management and lifecycle</b> across a large accommodation estate, supporting services plus building and plant renewal, sized into the government payment. With a state counterparty the margin is steady. The value rests on the <b>contracted payment and the low cost of capital</b> rather than the cost line.',
    wfNote:'Operating cost is the facilities management and lifecycle of a large accommodation estate, supporting services plus building and plant renewal. The payment is set to cover it at a contracted margin; the value sits in the indexed, government-backed payment and the very low state cost of capital.',
