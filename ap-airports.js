...
(function(){
  ...
  atlanta:{
    ...
    lede:'The world\'s busiest airport by passengers, and a <b>city-owned</b> public enterprise rather than a private asset: it runs at cost recovery, funded by airline agreements and tax-exempt bonds.',
    ...
    wfNote:'Operating cost is staff, security and the upkeep of an enormous fixed plant. Because charges are set residually to recover exactly this (plus debt service), the airport runs lean; any surplus is recycled into capital, never distributed.',
    ...
    finNote:'A US hub is a <b>credit, not an equity</b>: investors buy the revenue bonds; the airport itself is not for sale. The residual agreement and a near-monopoly hub make the bonds very safe, which is why the cost of capital is low, but there is no private upside to capture, only a benchmark of what a prime gateway is worth.',
  ...
  sydney:{
    ...
    wfNote:'Operating cost is staff, security and the upkeep of a compact, constrained estate, modest against a very large, dual-till revenue base. The margin is among the best in the sector; what determines the return is the price paid rather than the running cost.',
  ...
  dubai:{
    ...
    mb:{tag:'Model B · state hub', title:'Government-owned strategic hub', body:'A government-owned airport run as a strategic asset and a commercial powerhouse, keeping both tills and using the hub to anchor a trade, tourism and aviation economy. Commercially strong and dollar-denominated, but exposed to <b>hub competition and geopolitics</b>, and owned by a state rather than a financial investor. <b>This is Dubai</b>, owned by the Government of Dubai, the world\'s busiest international airport.'},
