...
(function(){
  ...
  atlanta:{
    ...
    wfNote:'Operating cost is staff, security and the upkeep of an enormous fixed plant. Because charges are set residually to recover exactly this (plus debt service), the airport runs lean; any surplus is recycled into capital rather than distributed.',
    ...
    finNote:'A US hub is a <b>credit, not an equity</b>: what investors buy is the revenue bonds rather than the airport itself. The residual agreement and a near-monopoly hub make the bonds very safe, which is why the cost of capital is low, but there is no private upside to capture, only a benchmark of what a prime gateway is worth.',
