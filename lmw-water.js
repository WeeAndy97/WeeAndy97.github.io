...
(function(){
  ...
  gwr:{
    ...
    wfNote:'Operating cost is treatment, recycling, pumping and customer service across a growing desert footprint. The swing factors for value are connections growth and the allowed return rather than the volume in any one year.',
  ...
  flow:{
    ...
    s4a:'Operating cost is the bought-in potable water and the treatment, recycling, pumping and billing within the precinct, but recycling cuts the potable bill and the bundled charge keeps the margin healthy. What carries the value is the connections base and the pipeline of new precincts.',
  ...
  enowawater:{
    ...
    s4a:'In the early years the network is built but lightly used, so opex is small against a base that is not yet fully earning; the picture is dominated by <b>capital</b>. As occupancy climbs, a modern, recycling-designed network runs efficiently and the margin builds. Everything rides on the ramp.',
  ...
  cwa:{
    ...
    s4a:'Operating cost is treatment, pumping, network O&amp;M and a large customer operation across many cities, significant in absolute terms but modest against the revenue from a vast connection base, so the margin is steady. The driver is the connections-and-volume growth of urbanisation rather than the cost line.',
    wfNote:'Operating cost is treatment, pumping and customer operations across many cities, large in absolute terms but modest against the revenue from a vast base. The swing factors are connections and volume growth rather than the tariff in any one year.',
