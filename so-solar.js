...
(function(){
  ...
  atacama:{
    ...
    finNote:'Atacama solar is a <b>world-best generation asset at an EM discount rate</b>: exceptional capacity factor and tiny opex, but spot-price and grid risk, carried against Chilean cost of capital. The whole debate is the discount rate and the offtake mix; the sun needs no underwriting.',
  ...
  aldhafra:{
    ...
    s4a:'There is no fuel and almost no operating cost: <b>O&amp;M</b> (cleaning, inverters) is a few percent of even a record-low revenue. The waterfall is short and the <b>margin wide</b>; what remains is the (very cheap) capex, the high capacity factor, and the very low cost of capital against a 30-year PPA.',
  ...
  chinapv:{
    ...
    s4b:'The capital is gigawatt-scale fixed-tilt panels, inverters, substations and, critically, the long <b>UHV transmission</b> to the eastern load centres. Capex per MWp is very low at this scale, and the financing is at a low, often state-linked cost of capital. Growth is simply more bases; the binding constraint is transmission and curtailment rather than the panels.',
