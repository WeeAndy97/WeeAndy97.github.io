...
(function(){
  ...
  rotterdam:{
    ...
    s3:'The landlord earns two ways. <b>Seaport dues</b> are charged on every ship that calls, scaled by its tonnage; volume-linked, they rise and fall with trade. <b>Contract revenue</b> is the rent on long, often inflation-linked <b>land-lease concessions</b> with the terminal operators; it is stable, and the larger of the two. The decisive investor question is the mix: the more of the cash flow that is contracted rent rather than throughput-linked dues, the more the port behaves like core infrastructure.',
  ...
  la:{
    ...
    s1:'<p class="body">The Port of Los Angeles is the western hemisphere\'s busiest container gateway, handling <b>10.3&nbsp;million TEU</b> in 2024 across the San Pedro Bay. Like Rotterdam it is a <b>landlord</b>, leasing its terminals to operators such as APM (Pier&nbsp;400), Fenix and Yusen, but with a twist: it is owned outright by the <b>City of Los Angeles</b>, run as a self-supporting public enterprise.</p>'+
    ...
    wfNote:'Operating cost is harbour maintenance, dredging, security and overhead, plus the city\'s public-works obligations. It is mostly fixed; the swing factor for a municipal port is the volume that drives the wharfage line above rather than the cost line.',
    s4b:'The port funds itself: no city taxes, just <b>revenue bonds</b> (only ~$298m outstanding, AA-rated) and retained surpluses. Big-ticket capital, from terminal modernisation and on-dock rail to the zero-emission transition (helped by a $412m federal EPA grant in 2024), is paid from cash flow and grants, which is why leverage stays low.',
  ...
  melbourne:{
    ...
    wfNote:'Operating cost is channel and asset maintenance plus a lean overhead; the operators bear the handling cost. The margin is high and stable; what determines the return is the price paid for the 50-year lease rather than the running cost.',
    s4b:'The headline number is the <b>A$9.7&nbsp;billion lease premium</b> paid in 2016, funded by the consortium with equity from its members and long-dated debt against the stable cash flow. Committed capital to expand capacity sits on top. At that price the port changed hands at a rich multiple, which is where the debate sits: a wonderful asset, but bought at a wonderful-asset price.',
  ...
  shanghai:{
    ...
    try:'<b>Try this:</b> the per-box handling fee in China is <b>low</b>, a fraction of a Western terminal\'s, yet the revenue is vast, because the volume is unmatched. The model is scale, and price barely matters. Push throughput toward 60&nbsp;million and watch the cash flow: this is what owning the world\'s busiest gateway looks like.',
    ...
    calcNote:'A working model calibrated to a <b>state-owned operator at scale</b>, on an enterprise-value basis. The per-box fee is low but the volume is vast, and a large port-services business is captured as ancillary income. State backing supports a low cost of debt, and the return that comes out is solid on an enormous base.',
