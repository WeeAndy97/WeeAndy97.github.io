...
(function(){
  ...
  dogger:{
    ...
    s3:'Dogger Bank and Hornsea sell <b>generation</b> (capacity × hours × capacity factor) under a <b>CfD</b> that fixes the price at a strike, inflation-linked, for fifteen years and beyond. So the revenue is contracted and price-insulated; the <b>margin</b> is generation revenue minus O&amp;M (which offshore is higher than onshore: heavy maintenance vessels, subsea cables). What sets the class apart is <b>capital-intensity</b>: the build is the asset, funded by project finance, so the unlevered return is modest (~6–8%) but high leverage lifts the equity return.',
  ...
  brazil:{
    ...
    s1:'<p class="body">Brazil has some of the best wind in the world off its north-east coast, and a vast offshore <b>pipeline</b> in environmental licensing, but no large offshore wind farm is yet operating. It is an <b>early-stage, pre-commercial</b> market: the legal framework for seabed leasing is still being finalised, and the first projects are years away.</p>'+
       '<p class="body">When they come, the model will be a <b>contracted generator</b>: power sold under long auctions or corporate <b>PPAs</b> at a fixed, indexed price, so the revenue is contracted. For an investor everything turns on the <b>discount rate</b>: a capital-heavy build, priced and financed at Brazilian rates and in reais, nets a solid contracted return down once discounted like an emerging-market asset. <b>The figures here are illustrative</b>: there is no operating project to draw on.</p>',
  ...
  china:{
    ...
    s1:'<p class="body">China is by far the world\'s largest offshore wind market, it has installed more capacity than every other country combined, in barely a decade, along its long east coast from the Yellow Sea to the South China Sea. The build-out is <b>fast and vast</b>: huge state-linked developers, a domestic supply chain and turbines of ever-increasing size.</p>'+
       '<p class="body">The model is a <b>contracted generator</b>: projects have been built under a national or provincial <b>feed-in tariff</b> and increasingly regulated or auctioned offtake, so the revenue is contracted at a fixed price. What distinguishes it is <b>scale and speed</b> (a domestic supply chain has driven capex down sharply) and a <b>low cost of capital</b> from state-linked financing, which is what makes a capital-heavy asset work at continental scale.</p>',
    ...
    finNote:'China offshore wind is a <b>contracted, capital-heavy generator at continental scale</b>: a price-insulated feed-in cash flow on a build whose capex keeps falling, carried at a low, state-linked cost of capital. The model runs on scale and cost rather than price, and the build-out is relentless.',
