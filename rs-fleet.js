...
(function(){
  ...
  angel:{
    ...
    s2:'Watch the depot and the line. Trains stable in the <b>sidings</b>, the available fleet runs on the <b>mainline</b>, and the unavailable units sit in the <b>maintenance shed</b>. The owner\'s <b style="color:#0c6b4f">money</b> is the <b>lease rate on every available unit</b>, so the income turns on the size of the fleet, the rate per unit, and how much of it is available; how many passengers ride never enters it. Drag the fleet, the lease rate and the availability.',
    ...
    s4a:'A full-service ROSCO carries a real cost: <b>heavy maintenance, overhaul and component renewal</b> to keep the fleet available, plus depot and admin. So the margin is healthy but not enormous, lower than a bare finance lease. Opex matters less than the <b>fleet and its availability</b>: each available unit is a contracted, indexed annuity, and the residual value sits behind it.',
  ...
  gatx:{
    ...
    lede:'A listed <b>railcar lessor</b> that owns tank cars and freight wagons and leases them to shippers and railroads on operating leases: a cyclical, residual-risk version of the leasing model.',
  ...
  lima:{
    ...
    lede:'A driverless metro under a <b>transport PPP</b>: the rolling stock is provided and maintained under an availability concession, with the state paying for trains kept available rather than for passengers carried.',
  ...
  sydney:{
    ...
    s4a:'The consortium carries <b>full fleet maintenance and overhaul</b> over the term, plus depot operations, sized so the availability payment covers it at a contracted margin. Because the offtaker is investment-grade and the payment is locked, the margin is steady. What matters is less the cost line than the <b>contracted, indexed payment</b> and the low discount rate a government offtaker permits.',
    wfNote:'Operating cost is the through-life maintenance and overhaul of the fleet plus depot operations, sized against a contracted payment. With deductions for unavailability, keeping the fleet fit is the operational job; the value sits in the indexed, government-backed payment.',
  ...
  riyadh:{
    ...
    try:'<b>Try this:</b> raise the <b>availability</b> and watch the payment hold flat at the contracted level: the state pays for a driverless fleet kept <b>fit for service</b>, whatever the ridership. With a sovereign offtaker the discount rate is low, so the contracted annuity values richly. The operational job is keeping a large automated fleet available; deductions bite if it is not.',
    ...
    s4a:'The provider carries <b>full maintenance and overhaul</b> of a large driverless fleet plus depot and control-system operations, real and technical, because an automated metro must run to a tight timetable. The payment is set to cover it; with a sovereign offtaker the margin is steady. The value rests on the <b>contracted payment and the low cost of capital</b>.',
  ...
  crrc:{
    ...
    wfNote:'Operating cost is thin (a finance lease leaves maintenance with the lessee), so the lessor carries only origination, servicing and admin. The margin is high, close to a financing spread; the value is the scale of the book and the very low state cost of capital.',
