...
(function(){
  ...
  tgs:{
    ...
    wfNote:'Operating cost is compressor fuel, maintenance and overhead across a long network. The margin is decent but the swing factors are the tariff cycle and the macro rather than the cost line.',
  ...
  apa:{
    ...
    wfNote:'Operating cost is compressor fuel, maintenance and overhead, modest against contracted revenue. The swing factors are recontracting and growth capex rather than daily throughput.',
  ...
  aramco:{
    ...
    wfNote:'Operating cost is minimal: the investor holds usage rights, not the operations. The structure is close to pure margin; the return is engineered through entry price, leverage and the lease residual rather than through running cost.',
