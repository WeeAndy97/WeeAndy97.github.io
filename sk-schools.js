...
(function(){
  ...
  ukbsf:{
    ...
    s2:'Watch the campus. The schools stand <b>lit and available</b>; the playground and sports pitch sit alongside. The owner\'s <b style="color:#0c6b4f">money</b> is the <b>unitary charge on every available place</b>, so what earns the money is the pupil places, the charge per place and how fully available the buildings are; enrolment plays no part. Drop the availability and classrooms dim as a <b>deduction</b> bites. Drag the places, the charge and the availability.',
    ...
    try:'<b>Try this:</b> drop the <b>availability</b> and watch the unitary charge fall as a <b>deduction</b> bites: a schools PFI is paid only for buildings <b>available and fit to teach in</b>, never for pupil numbers. Then push the <b>places</b> slider: the bundle scales by batching more schools into one contract. The cash is contracted, indexed and government-backed; this is the lowest-risk PPP in the market.',
    ...
    s4a:'The consortium carries the <b>facilities-management</b> obligation over the term: cleaning, caretaking, grounds and <b>lifecycle renewal</b> of plant and fabric, plus a hard-FM and admin overhead. For schools this is <b>light</b>: simple, daytime buildings. So the margin is high and the cost line thin and predictable. What defines the asset is not opex but the <b>contracted, indexed unitary charge</b> and the availability behind it.',
    wfNote:'Operating cost is the light facilities management a schools PFI bundles in: cleaning, caretaking, grounds and the periodic lifecycle renewal of plant and fabric, plus a small admin overhead. It is real but light for simple daytime buildings, so the margin is high and the value lies in the contracted, indexed unitary charge.',
  ...
  alberta:{
    ...
    s2:'Picture a campus of standardised schools: the buildings stand lit and available, the sports pitch and drop-off alongside. The consortium\'s <b style="color:#0c6b4f">return</b> is the <b>availability charge on every available place</b>, contracted, indexed, province-backed, with deductions for unavailability. Drag the places, the charge and the availability to work a batched, fully contracted annuity with no demand risk.',
    ...
    s3:'The consortium earns a contracted, indexed <b>availability charge</b> for keeping the bundle of schools available and fit for use, with <b>deductions</b> for unavailability. There is <b>no demand risk</b>; enrolment is the province\'s. The income is therefore a clean, fully contracted annuity backed by an <b>investment-grade province</b>, set by the places, the charge per place and availability. Standardised designs and batching keep FM light and the margin healthy; what swings the value is availability and the discount rate.',
  ...
  belo:{
    ...
    lede:'A pioneering Brazilian <b>municipal schools PPP</b> in which a private partner builds and maintains a network of early-years and basic-education units, paid through an availability charge, with no demand risk.',
    s1:'<p class="body"><b>Belo Horizonte</b> ran one of Brazil\'s first municipal <b>schools PPPs</b>: a private partner built and now operates and maintains a <b>network of early-years and basic-education units</b> (creches and schools), while the municipality pays a contracted <b>availability charge</b> for keeping the units available and the non-pedagogical services running. Teaching stays public; the partner provides the buildings and the facilities.</p>'+
       '<p class="body">It is the schools availability PPP in <b>emerging-market</b> form. The partner takes <b>no demand risk</b> and earns an indexed payment for keeping the network available, with <b>deductions</b> for unavailability or service failure; enrolment is the city\'s. The units are bundled and standardised; FM is light. The contract is highly contracted, but it is an EM municipal concession: the cash is in reais and discounted at a higher rate than a developed-market PPP. (Figures here are illustrative.)</p>',
    ...
    s2:'The scene shows a network of standardised units, early-years and basic-education buildings, lit and available, with playgrounds alongside. The partner\'s <b style="color:#0c6b4f">return</b> is the <b>availability charge on every available place</b>, contracted and indexed, with deductions for unavailability. Drag the places, the charge and the availability; there is no demand risk, but there is an emerging-market discount rate.',
    driverLab:'Charge / place', availLab:'Availability', hrK:'Availability charge', yrS:'places × charge × availability',
    ledge:{a:'+ availability',b:'+ indexation',c:'− FM'}, demandLabel:'AVAILABILITY',
    ...
    mb:{tag:'Model B · municipal schools PPP', title:'Build-and-maintain schools network', body:'A municipal PPP in which a partner builds and maintains a network of early-years and basic-education units and is paid a contracted, indexed availability charge for keeping them available, with no demand risk, light non-pedagogical FM and deductions for unavailability. A fully contracted annuity priced against emerging-market rates. <b>This is the Belo Horizonte schools PPP</b>.'},
    ...
    finNote:'A municipal schools PPP is a <b>fully contracted availability annuity</b>: an indexed charge for keeping a network of units available, with no demand risk and light non-pedagogical FM. The investment debate centres on the <b>discount rate</b> (Brazilian municipal and currency risk) more than on the contract.',
  ...
  nsw:{
    ...
    s1:'<p class="body">New South Wales delivers batches of new schools through <b>availability PPPs</b>: a private consortium finances, builds and maintains a <b>bundle of new schools</b> over a long term, and the state education authority pays a contracted <b>availability charge</b> for each year the schools are available and fit to teach in. The consortium provides the buildings and facilities; teaching stays public.</p>'+
       '<p class="body">It is the cleanest form of the schools annuity. Enrolment is the state\'s concern, so the consortium takes <b>no demand risk</b> and earns an indexed availability charge over a 25-30 year term, with <b>deductions</b> for unavailable or under-performing buildings. Backed by a strong <b>investment-grade government offtaker</b> and denominated in Australian dollars, it is a low-risk, fully contracted, inflation-linked cash flow, the kind of social-infrastructure asset that anchors a core portfolio.</p>',
    ...
    s2:'Picture a campus of new schools, the buildings lit and available, sports pitch and bus drop-off alongside. The consortium\'s <b style="color:#0c6b4f">return</b> is the <b>availability charge on every available place</b>, contracted, indexed, government-backed, with deductions for unavailability. Drag the places, the charge and the availability. This is a core, fully contracted annuity with no demand risk.',
    driverLab:'Charge / place', availLab:'Availability', hrK:'Availability charge', yrS:'places × charge × availability',
    ledge:{a:'+ availability',b:'+ indexation',c:'− FM'}, demandLabel:'AVAILABILITY',
    ...
    s3:'The consortium earns a contracted, indexed <b>availability charge</b> for keeping the bundle of schools available and fit to teach in, with <b>deductions</b> for unavailable or under-performing buildings. There is <b>no demand risk</b> because enrolment is the state\'s. The income is a clean, fully contracted annuity backed by an <b>investment-grade government</b> offtaker; the places, the charge per place and availability set it. Low risk, long term, indexed: the core social-infrastructure archetype.',
    ...
    s4a:'The consortium carries the <b>facilities-management</b> obligation over the term (cleaning, caretaking, grounds and <b>lifecycle renewal</b> across the bundle, plus admin), sized so the availability charge covers it at a contracted margin. Because the offtaker is investment-grade and the charge is locked, the margin is steady. Everything turns on the <b>contracted, indexed charge</b> and the low discount rate a government offtaker permits; the cost line is secondary.',
    wfNote:'Operating cost is the facilities management of the bundle, cleaning, caretaking, grounds and periodic lifecycle renewal, plus admin, sized against a contracted charge. For simple daytime buildings it is light; the value rests on the indexed, government-backed availability charge.',
    s4b:'The capital is the <b>bundle of school buildings</b>, financed by the consortium and recovered over the long term. A <b>government contribution</b> may fund a portion, but the consortium funds the bulk and recovers it through the availability charge. Backed by an investment-grade offtaker and a contracted, indexed cash flow, this low-risk, long-life annuity gears well.',
    stackH:'The capital · the school buildings', splitL:'Who funds the build', splitR:'allocation',
  ...
  egypt:{
    ...
    lede:'An emerging Middle Eastern <b>schools-PPP programme</b> under which a private partner builds and maintains a batch of new schools on an availability concession, paid for keeping them available, with no demand risk.',
    s1:'<p class="body">Across the Gulf and in <b>Egypt</b>, governments have begun to deliver new schools through <b>availability PPPs</b>: a private partner designs, builds, finances and maintains a <b>batch of new schools</b>, and the state pays a contracted <b>availability charge</b> for keeping them available and fit for use. It applies the established schools-PPP model to a fast-growing, young population that needs new capacity quickly. (Flag and figures here are illustrative.)</p>'+
       '<p class="body">The economics mirror a schools availability PPP, with a <b>state-backed</b> twist: the counterparty is a sovereign or sovereign-backed government, so the cost of capital is moderate-to-low and the payment is secure. The partner leaves enrolment with the state, taking <b>no demand risk</b>, and earns an indexed charge for keeping the batch available, with <b>deductions</b> for unavailability. New, standardised buildings, light FM, and a contracted annuity in an emerging programme.</p>',
    ...
    s2:'A batch of new schools stands lit and available: standardised buildings with sports pitches and drop-offs alongside. The partner\'s <b style="color:#0c6b4f">return</b> is the <b>availability charge on every available place</b>, contracted, indexed, state-backed, with deductions for unavailability. Drag the places, the charge and the availability to test a contracted annuity in an emerging schools programme.',
    driverLab:'Charge / place', availLab:'Availability', hrK:'Availability charge', yrS:'places × charge × availability',
    ledge:{a:'+ availability',b:'+ indexation',c:'− FM'}, demandLabel:'AVAILABILITY',
    preset:'Load Egypt / Gulf PPP',
    try:'<b>Try this:</b> raise the <b>availability</b> and watch the charge hold flat at the contracted level: the state pays for schools kept <b>available</b>, whatever the enrolment. With a sovereign-backed offtaker the discount rate is moderate, so the contracted annuity values reasonably. The operational job is keeping a batch of new buildings available; deductions bite if it is not.',
  ...
  china:{
    ...
    s1:'<p class="body">China has used <b>public-private partnerships</b> to mobilise <b>social capital</b> for public facilities, including <b>schools</b>: a private partner builds and maintains a batch of school buildings, and the local government pays an <b>availability-style payment</b> over the contract term for keeping them available and serviced. The buildings and facilities are provided by the partner; teaching stays public. (Figures here are illustrative.)</p>'+
       '<p class="body">The economics mirror a schools availability PPP, at a very <b>low cost of capital</b>: the counterparty is a local government and the partner is often state-linked, so the payment is secure and financing cheap. The partner takes <b>no demand risk</b>, since enrolment is the government\'s, and earns an indexed payment for keeping the batch available, with <b>deductions</b> for unavailability. What that yields is a contracted annuity on standardised buildings at scale, with light FM, funded cheaply.</p>',
    ...
    s2:'The campus is a batch of standardised schools, buildings lit and available, sports pitches and drop-offs alongside. The partner\'s <b style="color:#0c6b4f">return</b> is the <b>availability-style payment on every available place</b>, contracted, indexed, government-backed, with deductions for unavailability. Drag the places, the charge and the availability; the model prices a contracted annuity funded at a low cost of capital.',
